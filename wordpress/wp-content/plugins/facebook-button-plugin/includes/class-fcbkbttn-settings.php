						...
						<table class="form-table bws_pro_version">
								...
								<td>
									<fieldset>
										...
										<label>
                                            ...
                                            <br />
                                            <span class="bws_info"><?php _e( 'This image will be used for all posts.', 'facebook-button-plugin' ); ?></span>
										</label><br />
									</fieldset>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<br />
									<span class="bws_info"><?php _e( 'Enter a custom description that will be used for all pages and posts. Leave blank to use a default page description.', 'facebook-button-plugin' ); ?></span>
								</td>
							</tr>
						</table>
					</div>
